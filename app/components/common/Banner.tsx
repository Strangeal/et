...
const Banner = (props: Props) => {
  return (
    <div className="skicky top-0 start-0 z-50 flex justify-between w-full p-3 border-b border-gray-15 bg-gray-10 dark:bg-gray-10 dark:border-gray-600">
      <div className="flex items-center mx-auto">
        <p className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
          ...
          <span className="text-[8px] sm:text-sm">
            ✨ Discover Your Dream Property with (brand name) {""}
            <Link
              href="#"
